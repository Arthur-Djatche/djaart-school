...
export const NAVIGATION = [
  ...
  { label: 'Documents en masse', to: '/documents/masse', roles: BULLETINS_ROLES, permission: 'acces.documents_masse' },
  {
    ...
    children: [
      { label: 'Établissement(s)', to: '/parametrage/etablissements', permission: 'acces.parametrage_etablissement' },
      { label: 'Années académiques', to: '/parametrage/annees-academiques', permission: 'acces.parametrage_academique' },
      { label: 'Départements', to: '/parametrage/departements', etablissementTypes: UNIVERSITAIRE, permission: 'acces.parametrage_academique' },
      { label: 'Filières', to: '/parametrage/filieres', permission: 'acces.parametrage_academique' },
      { label: 'Classes', to: '/parametrage/classes', permission: 'acces.parametrage_academique' },
      { label: 'Matières', to: '/parametrage/matieres', permission: 'acces.parametrage_academique' },
      { label: "Unités d'enseignement", to: '/parametrage/unites-enseignement', etablissementTypes: UNIVERSITAIRE, permission: 'acces.parametrage_academique' },
    ],
  },
  {
    label: 'Finance',
