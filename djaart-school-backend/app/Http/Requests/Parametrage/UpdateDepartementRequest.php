    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'code' => [
                ...
                'string',
                'max:50',
                Rule::unique('departements', 'code')->where('etablissement_id', $departement->etablissement_id)->ignore($departement->id),
            ],
            'chef_departement_id' => [
                'nullable',
                Rule::exists('users', 'id')->where('etablissement_id', $departement->etablissement_id),
            ],
        ];
    }
