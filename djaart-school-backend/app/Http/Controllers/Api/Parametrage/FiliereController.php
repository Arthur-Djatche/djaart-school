...
class FiliereController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $filieres = Filiere::query()
            ->with('departement.chefDepartement')
    ...
    public function store(StoreFiliereRequest $request)
    {
        ...
        return $this->success(new FiliereResource($filiere->load('departement.chefDepartement')), 'Filière créée.', 201);
    }
    ...
    public function update(UpdateFiliereRequest $request, Filiere $filiere)
    {
        ...
        return $this->success(new FiliereResource($filiere->load('departement.chefDepartement')), 'Filière mise à jour.');
    }
